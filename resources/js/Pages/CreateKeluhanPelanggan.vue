...
import { createKeluhanPelanggan } from "../services/KeluhanPelanggan";
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            this.success = false;
            try {
                await createKeluhanPelanggan(this.form);
                this.$router.push({
                    name: "keluhan_pelanggan",
                    query: { message: "Keluhan berhasil dibuat!" },
                });
            } catch (e) {
                if (e.response && e.response.data && e.response.data.errors) {
                    ...
                    this.error =
                        e.message || "Terjadi kesalahan saat mengirim keluhan.";
                }
            }
        },
    },
